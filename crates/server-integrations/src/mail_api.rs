...
pub async fn create_account<S: IntegrationsState>(
    State(state): State<S>,
...
pub async fn mail_messages<S: IntegrationsState>(
    State(state): State<S>,
...
pub async fn mail_message_detail<S: IntegrationsState>(
    State(state): State<S>,
...
pub async fn send_email<S: IntegrationsState>(
    State(state): State<S>,
    Path(id): Path<String>,
...
pub async fn download_attachment<S: IntegrationsState>(
