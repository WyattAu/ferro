...
pub async fn admin_audit<S: AdminState>(
    State(state): State<S>,
...
pub async fn admin_maintenance<S: AdminState>(
    State(state): State<S>,
...
pub async fn admin_export_user_data<S: AdminState>(
    State(state): State<S>,
...
pub async fn admin_erase_user_data<S: AdminState>(
    State(state): State<S>,
    Path(user_id): Path<String>,
) -> Response {
    let user = match state.user_store().get_user(&user_id).await {
...
pub async fn admin_get_user<S: AdminState>(
    State(state): State<S>,
    Path(id): Path<String>,
) -> Response {
...
pub async fn admin_delete_user<S: AdminState>(
    State(state): State<S>,
    Path(id): Path<String>,
) -> Response {
