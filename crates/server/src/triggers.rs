//! Event triggers: configurable file event handlers for workflow automation (G-16).
//!
...
pub struct EventTrigger {
    ...
    /// Human-readable name.
    pub name: String,
    /// Event type to listen for (e.g., "file.upload", "file.delete").
    pub event: String,
    /// Optional path prefix filter (e.g., "/documents/").
    pub path_prefix: Option<String>,
    /// Glob pattern for path matching (e.g., "*.pdf").
    pub path_pattern: Option<String>,
    /// Action type: "webhook", "notification", "retention", "tag".
    pub action: String,
...
/// Global trigger store (lazily initialized).
...
impl TriggerStore {
    ...
    /// Find triggers matching an event and path.
...
// ---------------------------------------------------------------------------
// Trigger evaluation (called from event dispatch)
// ---------------------------------------------------------------------------
