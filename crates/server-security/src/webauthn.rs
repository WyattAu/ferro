...
use ferro_auth::webauthn::{WebAuthnConfig, WebAuthnCredential};
...
pub async fn webauthn_register_finish<S: SecurityAppState>(
    ...
    let result = ferro_auth::webauthn::verify_registration(
        &challenge_bytes,
...
pub async fn webauthn_login_finish<S: SecurityAppState>(
    ...
    let result =
        ferro_auth::webauthn::verify_authentication(&ferro_auth::webauthn::AuthenticationParams {
            challenge_bytes,
