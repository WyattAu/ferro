        ...
        <div class="h-screen flex flex-col bg-gray-100 dark:bg-gray-900">
            ...
            <div class="flex-1 overflow-auto px-2 sm:px-4 pt-16">
                <main id="main-content" class="max-w-7xl w-full mx-auto p-6">
                    <h1 class="text-2xl font-bold font-mono text-gray-900 dark:text-white mb-6">{t!("dashboard.title")}</h1>
                    ...
                    {move || dashboard.get().map(|data| {
                        ...
                        view! {
                            ...
                            <section class="mb-8" aria-labelledby="storage-heading">
                                <h2 id="storage-heading" class="text-sm font-bold uppercase font-mono text-gray-500 mb-3">{t!("dashboard.storage")}</h2>
                                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 brutal-border">
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <span class="text-xs font-mono text-gray-500">{pct_display}</span>
                                    </div>
                                    <div class="w-full h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden" role="progressbar" aria-valuenow=used aria-valuemin="0" aria-valuemax=total aria-label=t!("dashboard.storage_progress")>
                                        <div class="h-full bg-blue-500 rounded-full transition-all duration-500" style=bar_width></div>
                                    </div>
                            ...
                            <section class="mb-8" aria-labelledby="actions-heading">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    <a href="/ui/files/"
                                       class="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-600 text-white text-sm font-bold uppercase rounded-lg hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 min-h-[44px]"
                                    ...
                                    <a href="/ui/files/"
                                       class="inline-flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-bold uppercase rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 min-h-[44px]"
                                    ...
                                    >
                                        {
                                            ...
                                            view! {
                                                <li class="px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                                    <div class="flex items-center justify-between">
                                                        <div class="min-w-0">
                                                            <div class="text-sm font-mono text-gray-900 dark:text-white truncate" title=file.path.clone()>
                                                                {file_name}
                                                            </div>
                                                            <div class="text-xs text-gray-500 font-mono">{ts}</div>
                                                        </div>
                                                    </div>
                                                </li>
                                            }
                                    ...
                                    >
                                        {
                                            ...
                                            view! {
                                                <li class="px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                                    <div class="flex items-center justify-between">
                                                        <div class="min-w-0">
                                                            <div class="text-sm font-mono text-gray-900 dark:text-white truncate" title=share_path>
                                                                {file_name}
                                                            </div>
                                        ...
                                        view! {
                                            <li class="px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div class="min-w-0">
                                                        <div class="text-sm font-mono text-gray-900 dark:text-white truncate" title=entry_path.clone()>
                                                            {file_name}
                                                        </div>
                                                        <div class="text-xs text-gray-500 font-mono">
                                                            {action} " · " {ts_display}
