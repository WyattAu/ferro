        ...
        <div class="h-screen flex flex-col bg-[var(--bg-base)]">
            ...
            <div class="flex-1 flex overflow-hidden pt-16">
                ...
                <main id="main-content" class="flex-1 overflow-auto p-6">
                    ...
                    {/* Tab Navigation */}
                    <div class="flex flex-wrap items-center gap-1 mb-6" role="tablist" aria-label="Admin tabs">
                        <button role="tab" aria-selected=move || tab.get() == AdminTab::Overview aria-controls="panel-overview" id="tab-overview" on:click=move |_| on_tab_change(AdminTab::Overview) class=move || format!("px-3 py-1.5 text-sm font-medium rounded-lg transition-colors {}", if tab.get() == AdminTab::Overview { "bg-[var(--accent)] text-[var(--text-on-accent)]" } else { "text-[var(--text-secondary)] dark:text-[var(--text-tertiary)] hover:bg-[var(--interactive-hover)]" })>{t!("admin.tab_overview")}</button>
                        <button role="tab" aria-selected=move || tab.get() == AdminTab::Users aria-controls="panel-users" id="tab-users" on:click=move |_| on_tab_change(AdminTab::Users) class=move || format!("px-3 py-1.5 text-sm font-medium rounded-lg transition-colors {}", if tab.get() == AdminTab::Users { "bg-[var(--accent)] text-[var(--text-on-accent)]" } else { "text-[var(--text-secondary)] dark:text-[var(--text-tertiary)] hover:bg-[var(--interactive-hover)]" })>{t!("admin.tab_users")}</button>
                        <button role="tab" aria-selected=move || tab.get() == AdminTab::DlpPolicies aria-controls="panel-dlp" id="tab-dlp" on:click=move |_| on_tab_change(AdminTab::DlpPolicies) class=move || format!("px-3 py-1.5 text-sm font-medium rounded-lg transition-colors {}", if tab.get() == AdminTab::DlpPolicies { "bg-[var(--accent)] text-[var(--text-on-accent)]" } else { "text-[var(--text-secondary)] dark:text-[var(--text-tertiary)] hover:bg-[var(--interactive-hover)]" })>{t!("admin.tab_dlp")}</button>
                        <button role="tab" aria-selected=move || tab.get() == AdminTab::DlpAlerts aria-controls="panel-dlp-alerts" id="tab-dlp-alerts" on:click=move |_| on_tab_change(AdminTab::DlpAlerts) class=move || format!("px-3 py-1.5 text-sm font-medium rounded-lg transition-colors {}", if tab.get() == AdminTab::DlpAlerts { "bg-[var(--accent)] text-[var(--text-on-accent)]" } else { "text-[var(--text-secondary)] dark:text-[var(--text-tertiary)] hover:bg-[var(--interactive-hover)]" })>{t!("admin.tab_dlp_alerts")}</button>
                        <button role="tab" aria-selected=move || tab.get() == AdminTab::Antivirus aria-controls="panel-antivirus" id="tab-antivirus" on:click=move |_| on_tab_change(AdminTab::Antivirus) class=move || format!("px-3 py-1.5 text-sm font-medium rounded-lg transition-colors {}", if tab.get() == AdminTab::Antivirus { "bg-[var(--accent)] text-[var(--text-on-accent)]" } else { "text-[var(--text-secondary)] dark:text-[var(--text-tertiary)] hover:bg-[var(--interactive-hover)]" })>{t!("admin.tab_antivirus")}</button>
                        <button role="tab" aria-selected=move || tab.get() == AdminTab::Watermarks aria-controls="panel-watermarks" id="tab-watermarks" on:click=move |_| on_tab_change(AdminTab::Watermarks) class=move || format!("px-3 py-1.5 text-sm font-medium rounded-lg transition-colors {}", if tab.get() == AdminTab::Watermarks { "bg-[var(--accent)] text-[var(--text-on-accent)]" } else { "text-[var(--text-secondary)] dark:text-[var(--text-tertiary)] hover:bg-[var(--interactive-hover)]" })>{t!("admin.tab_watermarks")}</button>
                        <button role="tab" aria-selected=move || tab.get() == AdminTab::Notifications aria-controls="panel-notifications" id="tab-notifications-admin" on:click=move |_| on_tab_change(AdminTab::Notifications) class=move || format!("px-3 py-1.5 text-sm font-medium rounded-lg transition-colors {}", if tab.get() == AdminTab::Notifications { "bg-[var(--accent)] text-[var(--text-on-accent)]" } else { "text-[var(--text-secondary)] dark:text-[var(--text-tertiary)] hover:bg-[var(--interactive-hover)]" })>{t!("admin.tab_notifications")}</button>
                    </div>
